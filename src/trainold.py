...
epochs = 3 #Epoch count is the number of times all training data is shown to the network during training.
cuda = False
...
print("Model Saved!")
my_model = torch.load('model/model.pth')
...
def predict(test_input_path_list):
    ...
    for i in range(len(test_input_path_list)):
